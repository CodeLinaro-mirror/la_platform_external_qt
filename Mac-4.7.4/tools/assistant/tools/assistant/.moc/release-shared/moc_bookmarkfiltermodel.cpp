...
**
** Created: Mon Jul 16 19:41:14 2012
...
const QMetaObject BookmarkFilterModel::staticMetaObject = {
    { &QAbstractProxyModel::staticMetaObject, qt_meta_stringdata_BookmarkFilterModel,
      qt_meta_data_BookmarkFilterModel, 0 }
};
...
int BookmarkFilterModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: changed((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< const QModelIndex(*)>(_a[2]))); break;
        ...
        case 3: rowsRemoved((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 4: layoutAboutToBeChanged(); break;
        case 5: layoutChanged(); break;
        case 6: modelAboutToBeReset(); break;
        case 7: modelReset(); break;
        default: ;
        }
        _id -= 8;
    }
...
const QMetaObject BookmarkTreeModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_BookmarkTreeModel,
      qt_meta_data_BookmarkTreeModel, 0 }
};
