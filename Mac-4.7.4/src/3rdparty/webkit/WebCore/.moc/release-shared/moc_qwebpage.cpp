...
**
** Created: Mon Jul 16 19:15:10 2012
...
static const uint qt_meta_data_QWebPage[] = {
 ...
 // enum data: key, value
    ...
    2368, uint(QWebPage::StopScheduledPageRefresh),
    2393, uint(QWebPage::WebActionCount),
    2408, uint(QWebPage::DontDelegateLinks),
    2426, uint(QWebPage::DelegateExternalLinks),
    2448, uint(QWebPage::DelegateAllLinks),
