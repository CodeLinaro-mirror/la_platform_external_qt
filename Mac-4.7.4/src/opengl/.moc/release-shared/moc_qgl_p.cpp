...
**
** Created: Mon Jul 16 17:39:46 2012
...
const QMetaObject QGLTextureDestroyer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QGLTextureDestroyer,
      qt_meta_data_QGLTextureDestroyer, 0 }
};
...
int QGLTextureDestroyer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: freeTexture((*reinterpret_cast< QGLContext*(*)>(_a[1])),(*reinterpret_cast< QPixmapData*(*)>(_a[2])),(*reinterpret_cast< GLuint(*)>(_a[3]))); break;
        case 1: freeTexture_slot((*reinterpret_cast< QGLContext*(*)>(_a[1])),(*reinterpret_cast< QPixmapData*(*)>(_a[2])),(*reinterpret_cast< GLuint(*)>(_a[3]))); break;
        default: ;
        }
        _id -= 2;
    }
