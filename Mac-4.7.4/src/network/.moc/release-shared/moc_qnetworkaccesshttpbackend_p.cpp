...
**
** Created: Mon Jul 16 17:07:30 2012
...
static const char qt_meta_stringdata_QNetworkAccessHttpBackend[] = {
    ...
    "httpCacheCredentials(QHttpNetworkRequest,QAuthenticator*)\0"
    "error,errorString\0"
...
int QNetworkAccessHttpBackend::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: httpCacheCredentials((*reinterpret_cast< const QHttpNetworkRequest(*)>(_a[1])),(*reinterpret_cast< QAuthenticator*(*)>(_a[2]))); break;
        case 5: httpError((*reinterpret_cast< QNetworkReply::NetworkError(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 6: { bool _r = sendCacheContents((*reinterpret_cast< const QNetworkCacheMetaData(*)>(_a[1])));
