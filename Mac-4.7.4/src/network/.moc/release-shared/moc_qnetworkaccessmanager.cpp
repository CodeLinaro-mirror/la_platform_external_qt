...
**
** Created: Mon Jul 16 17:05:27 2012
...
int QNetworkAccessManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: networkSessionConnected(); break;
        case 5: networkAccessibleChanged((*reinterpret_cast< QNetworkAccessManager::NetworkAccessibility(*)>(_a[1]))); break;
        case 6: d_func()->_q_replyFinished(); break;
        case 7: d_func()->_q_replySslErrors((*reinterpret_cast< QList<QSslError>(*)>(_a[1]))); break;
        case 8: d_func()->_q_networkSessionClosed(); break;
        case 9: d_func()->_q_networkSessionStateChanged((*reinterpret_cast< QNetworkSession::State(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 10;
    }
