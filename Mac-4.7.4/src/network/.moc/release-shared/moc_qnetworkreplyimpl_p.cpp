...
**
** Created: Mon Jul 16 17:05:56 2012
...
static const char qt_meta_stringdata_QNetworkReplyImpl[] = {
    ...
    "_q_networkSessionFailed()\0QSslConfiguration\0"
...
int QNetworkReplyImpl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: d_func()->_q_networkSessionConnected(); break;
        case 6: d_func()->_q_networkSessionFailed(); break;
        case 7: { QSslConfiguration _r = sslConfigurationImplementation();
            if (_a[0]) *reinterpret_cast< QSslConfiguration*>(_a[0]) = _r; }  break;
        case 8: setSslConfigurationImplementation((*reinterpret_cast< const QSslConfiguration(*)>(_a[1]))); break;
        case 9: ignoreSslErrorsImplementation((*reinterpret_cast< const QList<QSslError>(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 10;
    }
...
const QMetaObject QDisabledNetworkReply::staticMetaObject = {
    { &QNetworkReply::staticMetaObject, qt_meta_stringdata_QDisabledNetworkReply,
      qt_meta_data_QDisabledNetworkReply, 0 }
};
