...
**
** Created: Mon Jul 16 17:07:39 2012
...
const QMetaObject QNetworkSessionPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QNetworkSessionPrivate,
      qt_meta_data_QNetworkSessionPrivate, 0 }
};
...
int QNetworkSessionPrivate::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: quitPendingWaitsForOpened(); break;
        case 1: error((*reinterpret_cast< QNetworkSession::SessionError(*)>(_a[1]))); break;
        case 2: stateChanged((*reinterpret_cast< QNetworkSession::State(*)>(_a[1]))); break;
        case 3: closed(); break;
        case 4: newConfigurationActivated(); break;
        case 5: preferredConfigurationChanged((*reinterpret_cast< const QNetworkConfiguration(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 6;
    }
