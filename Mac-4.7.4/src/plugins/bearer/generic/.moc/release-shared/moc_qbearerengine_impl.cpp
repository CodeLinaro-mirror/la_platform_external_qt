...
**
** Created: Mon Jul 16 19:34:16 2012
...
const QMetaObject QBearerEngineImpl::staticMetaObject = {
    { &QBearerEngine::staticMetaObject, qt_meta_stringdata_QBearerEngineImpl,
      qt_meta_data_QBearerEngineImpl, 0 }
};
...
int QBearerEngineImpl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: connectionError((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< QBearerEngineImpl::ConnectionError(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
