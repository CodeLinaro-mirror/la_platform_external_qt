...
**
** Created: Mon Jul 16 17:23:34 2012
...
static const uint qt_meta_data_QComboBox[] = {
 ...
 // enum data: key, value
     879, uint(QComboBox::NoInsert),
     888, uint(QComboBox::InsertAtTop),
     900, uint(QComboBox::InsertAtCurrent),
     916, uint(QComboBox::InsertAtBottom),
     931, uint(QComboBox::InsertAfterCurrent),
     950, uint(QComboBox::InsertBeforeCurrent),
     970, uint(QComboBox::InsertAlphabetically),
     991, uint(QComboBox::AdjustToContents),
    1008, uint(QComboBox::AdjustToContentsOnFirstShow),
    1036, uint(QComboBox::AdjustToMinimumContentsLength),
    1066, uint(QComboBox::AdjustToMinimumContentsLengthWithIcon),
