...
**
** Created: Mon Jul 16 17:34:27 2012
...
static const uint qt_meta_data_QCocoaDropData[] = {
...
static const char qt_meta_stringdata_QCocoaDropData[] = {
    "QCocoaDropData\0"
};

const QMetaObject QCocoaDropData::staticMetaObject = {
    { &QInternalMimeData::staticMetaObject, qt_meta_stringdata_QCocoaDropData,
      qt_meta_data_QCocoaDropData, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QCocoaDropData::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *QCocoaDropData::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *QCocoaDropData::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QCocoaDropData))
        return static_cast<void*>(const_cast< QCocoaDropData*>(this));
    return QInternalMimeData::qt_metacast(_clname);
}

int QCocoaDropData::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QInternalMimeData::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
